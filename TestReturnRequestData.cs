public class TestReturnRequestData
{
    ...
    public TestReturnRequestData(string appid, string mchid, string description, string out_trade_no, string time_expire, string attach, string notify_url, string goods_tag, Amount amount, Payer payer, Detail detail, Scene_Info scene_info, Settle_Info settle_info)
    {
        this.appid = appid;
        this.mchid = mchid;
