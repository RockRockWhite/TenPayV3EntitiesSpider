public class chapter6_1_1RequestData
{
...
/// <param name="notify_url">商户回调地址  <para>body商户接收扣款成功回调通知的地址，服务需要收款时此参数必填；服务无需收款时此参数不填。</para><para>示例值：https://api.test.com</para><para>可为null</para></param>
        public chapter6_1_1RequestData(string out_order_no, string appid, string openid, string service_id, string service_introduction, Post_Payments[] post_payments, Post_Discounts[] post_discounts, Time_Range time_range, Location location, ulong total_amount, bool  profit_sharing, string goods_tag, string attach, string notify_url)
        {
...
this.notify_url = notify_url;
        ...
        /// 无参构造函数
        /// </summary>
        public chapter6_1_1RequestData()
        {
        }
