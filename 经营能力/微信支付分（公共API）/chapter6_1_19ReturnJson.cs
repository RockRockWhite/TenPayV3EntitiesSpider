public class chapter6_1_19ReturnJson
{
...
/// <param name="order_id">微信支付服务订单号  <para>微信支付服务订单号，每个微信支付服务订单号与商户号下对应的商户服务订单号一一对应。</para><para>示例值：15646546545165651651</para></param>
        public chapter6_1_19ReturnJson(string appid, string mchid, string out_order_no, string service_id, string order_id)
        {
        this.appid = appid;
this.mchid = mchid;
...
this.order_id = order_id;
        ...
        /// 无参构造函数
        /// </summary>
        public chapter6_1_19ReturnJson()
        {
        }
