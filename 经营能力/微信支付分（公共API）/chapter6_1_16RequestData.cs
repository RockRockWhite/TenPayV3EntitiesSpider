public class chapter6_1_16RequestData
{
...
/// <param name="reason">取消原因  <para>body最多30个字符，每个汉字/数字/英语都按1个字符计算超过长度报错处理。注：重录时需保证参数完全一致，包括取消原因</para><para>示例值：用户投诉</para></param>
        public chapter6_1_16RequestData(string out_order_no, string appid, string service_id, string reason)
        {
...
this.reason = reason;
        ...
        /// 无参构造函数
        /// </summary>
        public chapter6_1_16RequestData()
        {
        }
