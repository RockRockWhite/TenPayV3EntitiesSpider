public class chapter6_1_18RequestData
{
...
/// <param name="goods_tag">订单优惠标记  <para>body订单优惠标记，代金券或立减金优惠的参数，说明详见代金券或立减金优惠</para><para>示例值：goods_tag</para><para>可为null</para></param>
        public chapter6_1_18RequestData(string out_order_no, string appid, string service_id, Post_Payments[] post_payments, Post_Discounts[] post_discounts, long total_amount, Time_Range time_range, Location location, bool  profit_sharing, string goods_tag)
        {
...
this.goods_tag = goods_tag;
        ...
        /// 无参构造函数
        /// </summary>
        public chapter6_1_18RequestData()
        {
        }
