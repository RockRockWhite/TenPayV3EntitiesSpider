public class chapter6_1_22NotifyJson
{
...
/// <param name="collection">收款信息 <para>收款信息，非0元完结后返回</para><para>可为null</para></param>
        public chapter6_1_22NotifyJson(string appid, string mchid, string out_order_no, string service_id, string openid, string state, string state_description, long total_amount, string service_introduction, Post_Payments[] post_payments, Post_Discounts[] post_discounts, Risk_Fund risk_fund, Time_Range time_range, Location location, string attach, string notify_url, string order_id, bool  need_collection, Collection collection)
        {
        this.appid = appid;
this.mchid = mchid;
...
this.collection = collection;
        ...
        /// 无参构造函数
        /// </summary>
        public chapter6_1_22NotifyJson()
        {
        }
