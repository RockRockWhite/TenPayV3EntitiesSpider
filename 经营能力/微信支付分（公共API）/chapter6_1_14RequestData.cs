public class chapter6_1_14RequestData
{
...
/// <param name="need_user_confirm">是否需要用户确认 <para>body枚举值：false：免确认订单true：需确认订单默认值true</para><para>示例值：true</para><para>可为null</para></param>
        public chapter6_1_14RequestData(string out_order_no, string appid, string service_id, string service_introduction, Post_Payments[] post_payments, Post_Discounts[] post_discounts, Time_Range time_range, Location location, Risk_Fund risk_fund, string attach, string notify_url, string openid, bool need_user_confirm)
        {
...
this.need_user_confirm = need_user_confirm;
        ...
        /// 无参构造函数
        /// </summary>
        public chapter6_1_14RequestData()
        {
        }
