public class chapter6_1_17ReturnJson
{
...
/// <param name="collection">收款信息 <para>服务使用信息</para><para>可为null</para></param>
        public chapter6_1_17ReturnJson(string appid, string mchid, string service_id, string out_order_no, string service_introduction, string state, string state_description, long total_amount, Post_Payments[] post_payments, Post_Discounts[] post_discounts, Risk_Fund risk_fund, Time_Range time_range, Location location, string attach, string notify_url, string order_id, bool  need_collection, Collection collection)
        {
        this.appid = appid;
this.mchid = mchid;
