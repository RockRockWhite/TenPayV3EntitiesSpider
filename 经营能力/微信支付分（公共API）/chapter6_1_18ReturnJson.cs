public class chapter6_1_18ReturnJson
{
...
/// <param name="need_collection">是否需要收款  <para>true：微信支付分代收款false：无需微信支付分代收款</para><para>示例值：true</para><para>可为null</para></param>
        public chapter6_1_18ReturnJson(string appid, string mchid, string out_order_no, string service_id, string service_introduction, string state, string state_description, long total_amount, Post_Payments[] post_payments, Post_Discounts[] post_discounts, Risk_Fund risk_fund, Time_Range time_range, Location location, string order_id, bool  need_collection)
        {
        this.appid = appid;
this.mchid = mchid;
...
this.need_collection = need_collection;
        ...
        /// 无参构造函数
        /// </summary>
        public chapter6_1_18ReturnJson()
        {
        }
