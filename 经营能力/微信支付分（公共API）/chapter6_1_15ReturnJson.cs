public class chapter6_1_15ReturnJson
{
...
/// <param name="openid">用户标识  <para>微信用户在商户对应appid下的唯一标识</para><para>示例值：oUpF8uMuAJO_M2pxb1Q9zNjWeS6o</para><para>可为null</para></param>
        public chapter6_1_15ReturnJson(string appid, string mchid, string service_id, string out_order_no, string service_introduction, string state, string state_description, long total_amount, Post_Payments[] post_payments, Post_Discounts[] post_discounts, Risk_Fund risk_fund, Time_Range time_range, Location location, string attach, string notify_url, string order_id, bool  need_collection, Collection collection, string openid)
        {
        this.appid = appid;
this.mchid = mchid;
...
this.openid = openid;
        ...
        /// 无参构造函数
        /// </summary>
        public chapter6_1_15ReturnJson()
        {
        }
