public class chapter6_1_17RequestData
{
...
/// <param name="reason">修改原因  <para>body按照字符计算，超过长度报错处理。</para><para>示例值：用户投诉</para></param>
        public chapter6_1_17RequestData(string out_order_no, string appid, string service_id, Post_Payments[] post_payments, Post_Discounts[] post_discounts, long total_amount, string reason)
        {
...
this.reason = reason;
        ...
        /// 无参构造函数
        /// </summary>
        public chapter6_1_17RequestData()
        {
        }
