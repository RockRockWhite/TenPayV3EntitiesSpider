public class chapter6_1_14ReturnJson
{
...
/// <param name="package">跳转微信侧小程序订单数据  <para>用户跳转到微信侧小程序订单数据，需确认模式特有API中调起支付分-确认订单传入。该数据一小时内有效。</para><para>示例值：DJIOSQPYWDxsjdldeuwhdodwxasd_dDiodnwjh9we</para></param>
        public chapter6_1_14ReturnJson(string appid, string mchid, string out_order_no, string service_id, string service_introduction, string state, string state_description, Post_Payments[] post_payments, Post_Discounts[] post_discounts, Risk_Fund risk_fund, Time_Range time_range, Location location, string attach, string notify_url, string order_id, string package)
        {
        this.appid = appid;
this.mchid = mchid;
...
this.package = package;
        ...
        /// 无参构造函数
        /// </summary>
        public chapter6_1_14ReturnJson()
        {
        }
