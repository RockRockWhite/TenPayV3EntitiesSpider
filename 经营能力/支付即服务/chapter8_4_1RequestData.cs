public class chapter8_4_1RequestData
{
...
/// <param name="group_qrcode">群二维码URL <para>body员工所在门店在企业微信配置的群活码的URL（可通过企业微信“获取客户群进群方式API”获取，请登录企业微信后查看API文档，若无查看权限可通过问卷提交需求）示例值：http://p.qpic.cn/wwhead/nMl9ssowtibVGyrmvBiaibzDtp/0</para><para>可为null</para></param>
        public chapter8_4_1RequestData(string corpid, int store_id, string userid, string name, string mobile, string qr_code, string avatar, string group_qrcode)
        {
        this.corpid = corpid;
...
this.group_qrcode = group_qrcode;
        ...
        /// 无参构造函数
        /// </summary>
        public chapter8_4_1RequestData()
        {
        }
