public class chapter8_6_3NotifyJson
{
...
/// <param name="refund_id">微信支付退款单号 <para>微信支付退款单号</para><para>示例值：1217752501201407033233368999</para></param>
        public chapter8_6_3NotifyJson(string mchid, string merchant_name, string shop_name, string shop_number, string appid, string openid, string refund_time, long pay_amount, long refund_amount, string transaction_id, string refund_id)
        {
        this.mchid = mchid;
