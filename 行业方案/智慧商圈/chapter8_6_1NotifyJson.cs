public class chapter8_6_1NotifyJson
{
...
/// <param name="commit_tag">手动提交积分标记 <para>手动提交积分标记，自动提交时无该字段，用于区分用户手动申请后推送的积分数据</para><para>示例值：oUpF8uMuAJ2pxb1Q9zNjWUHsd</para><para>可为null</para></param>
        public chapter8_6_1NotifyJson(string mchid, string merchant_name, string shop_name, string shop_number, string appid, string openid, string time_end, int  amount, string transaction_id, string commit_tag)
        {
        this.mchid = mchid;
