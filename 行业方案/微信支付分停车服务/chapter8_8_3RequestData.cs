public class chapter8_8_3RequestData
{
...
/// <param name="parking_info">停车场景信息 <para>body当交易场景为PARKING时，需要在该字段添加停车场景信息</para><para>可为null</para></param>
        public chapter8_8_3RequestData(string appid, string description, string attach, string out_trade_no, string trade_scene, string goods_tag, string notify_url, string profit_sharing, Amount amount, Parking_Info parking_info)
        {
        this.appid = appid;
...
this.parking_info = parking_info;
        ...
        /// 无参构造函数
        /// </summary>
        public chapter8_8_3RequestData()
        {
        }
