public class chapter8_8_6NotifyJson
{
...
/// <param name="promotion_detail">优惠功能 <para>优惠功能信息，详细说明见下文</para><para>可为null</para></param>
        public chapter8_8_6NotifyJson(string appid, string sp_mchid, string out_trade_no, string transaction_id, string description, string create_time, string trade_state, string trade_state_description, string success_time, string bank_type, string attach, string user_repaid, string trade_scene, Parking_Info parking_info, Payer payer, Amount amount, Promotion_Detail[] promotion_detail)
        {
        this.appid = appid;
