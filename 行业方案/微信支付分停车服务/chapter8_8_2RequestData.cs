public class chapter8_8_2RequestData
{
...
/// <param name="free_duration">免费时长 <para>body停车场的免费停车时长，单位为秒</para><para>示例值：3600</para></param>
        public chapter8_8_2RequestData(string out_parking_no, string plate_number, string plate_color, string notify_url, string start_time, string parking_name, int free_duration)
        {
...
this.free_duration = free_duration;
        ...
        /// 无参构造函数
        /// </summary>
        public chapter8_8_2RequestData()
        {
        }
