public class chapter8_8_3ReturnJson
{
...
/// <param name="promotion_detail">优惠信息 <para>优惠信息</para><para>可为null</para></param>
        public chapter8_8_3ReturnJson(string appid, string sp_mchid, string description, string create_time, string out_trade_no, string transaction_id, string trade_state, string trade_state_description, string success_time, string bank_type, string user_repaid, string attach, string trade_scene, Parking_Info parking_info, Payer payer, Amount amount, Promotion_Detail[] promotion_detail)
        {
        this.appid = appid;
